...
//----------------------------------
    marker_coord = nh.subscribe("aruco/pose", 1, arrayCallback);
//----------------------------------
...
//-------------------------------------------------------------------------------------------------------
	void arrayCallback(const geometry_msg::Pose& aruco/Pose){
...
//	float z=Arr[2];
	...
	int x=aruco/Pose.position.x;
	int y=aruco/Pose.position.y;
	int z=aruco/Pose.position.z;
